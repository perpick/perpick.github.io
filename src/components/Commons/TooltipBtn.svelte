...
<div class="flex flex-wrap">
  <div class="w-full text-center">
    ...
    <div
      id={tooltipId}
      class="hidden bg-pink-600 border-0 mt-3 z-50 font-normal leading-normal text-sm max-w-xs text-left no-underline break-words rounded-lg"
    >
      <div>
        <div
          class="bg-pink-600 text-white opacity-75 font-semibold p-3 mb-0 border-b border-solid border-gray-200 uppercase rounded-t-lg"
        >
          {descHead}
        </div>
